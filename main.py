...
class Management:
    def __init__(self, root):
        ...
        self.view_bt = Button(self.frame_2, text='View Details', font=(self.font_1, 12), bd=2, command=self.GetContact_View, cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=68,y=100,width=100)
        self.update_bt = Button(self.frame_2, text='Update', font=(self.font_1, 12), bd=2, command=self.GetContact_Update, cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=68,y=160,width=100)
        self.delete_bt = Button(self.frame_2, text='Delete', font=(self.font_1, 12), bd=2, command=self.GetContact_Delete,cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=68,y=220,width=100)
        self.clear_bt = Button(self.frame_2, text='Clear', font=(self.font_1, 12), bd=2, command=self.ClearScreen, cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=68,y=280,width=100)
    ...
    def AddStudent(self):
        ...
        self.name = Label(self.frame_1, text="Full Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=30)
        self.name_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=40,y=60, width=200)

        self.surname = Label(self.frame_1, text="Designation", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=30)
        ...
        self.subject = Label(self.frame_1, text="Address", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=100)
        self.subject_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.subject_entry.place(x=300,y=130, width=200)

        self.year = Label(self.frame_1, text="Year of Joined", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
    ...
    def ShowDetails(self, row):
        self.ClearScreen()
        name = Label(self.frame_1, text="Full Name", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=30)
        name_data = Label(self.frame_1, text=row[0], font=(self.font_1, 10)).place(x=40, y=60)

        surname = Label(self.frame_1, text="Designation", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=30)
        ...
        subject = Label(self.frame_1, text="Address", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=100)
        subject_data = Label(self.frame_1, text=row[3], font=(self.font_1, 10)).place(x=300, y=130)

        year = Label(self.frame_1, text="Year of Joined", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
        ...
        birth = Label(self.frame_1, text="DOB", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
        ...
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row==None:
                    ...
                    curs.execute("update student_register set f_name=%s,Designation=%s, course=%s, Address=%s, year=%s, age=%s, gender=%s, DOB=%s, email=%s where contact=%s",
                                        (
                                            self.name_entry.get(),
        ...
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.contact_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row!=None:
                    ...
                    curs.execute("insert into student_register (f_name,Designation,course,Address,year,age,gender,DOB,contact,email) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                        (
                                            self.name_entry.get(),
                                            self.surname_entry.get(),
                                            self.course_entry.get(),
